...
public interface DeptMapper {
    ...
    Long[] getDeptPost(@Param("deptid") Long deptid);
    void deleteDeptPost(@Param("deptid") Long deptid);
    void insertDeptPost(@Param("deptid") Long deptid,@Param("postid") Long postid);
    ...
    List<PostBean> getDeptPostList(Long deptid);
